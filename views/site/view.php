                        ...
                        <div class="post-block post-author clearfix">
                            ...
                            <div class="img-thumbnail">
                                <a href="blog-post.html">
                                    <img src="<?php echo $this->theme->baseUrl ?>/img/avatar.jpg" alt="">
                                </a>
                            </div>
                        ...
                        <div class="post-block post-comments clearfix">
                            ...
                            <ul class="comments">
                                <li>
                                    <div class="comment">
                                        <div class="img-thumbnail">
                                            <img class="avatar" alt="" src="<?php echo $this->theme->baseUrl ?>/img/avatar-2.jpg">
                                        </div>
                                    ...
                                    <ul class="comments reply">
                                        <li>
                                            <div class="comment">
                                                <div class="img-thumbnail">
                                                    <img class="avatar" alt="" src="<?php echo $this->theme->baseUrl ?>/img/avatar-3.jpg">
                                                </div>
                                                <div class="comment-block">
                                                    <div class="comment-arrow"></div>
																	<span class="comment-by">
                                        ...
                                        <li>
                                            <div class="comment">
                                                <div class="img-thumbnail">
                                                    <img class="avatar" alt="" src="<?php echo $this->theme->baseUrl ?>/img/avatar-4.jpg">
                                                </div>
                                                <div class="comment-block">
                                                    <div class="comment-arrow"></div>
																	<span class="comment-by">
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="img-thumbnail">
                                            <img class="avatar" alt="" src="<?php echo $this->theme->baseUrl ?>/img/avatar.jpg">
                                        </div>
                                        <div class="comment-block">
                                            <div class="comment-arrow"></div>
															<span class="comment-by">
